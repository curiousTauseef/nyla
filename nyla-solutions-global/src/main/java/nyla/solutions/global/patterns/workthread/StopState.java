...
public class StopState implements WorkState
{
   ...
   /**
    * 
    * @see nyla.solutions.global.patterns.workthread.WorkState#advise(nyla.solutions.global.patterns.workthread.SupervisedWorker)
    */
   ...
   /**
    * 
    * @see nyla.solutions.global.patterns.workthread.WorkState#getName()
    */
