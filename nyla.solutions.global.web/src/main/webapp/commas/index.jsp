        ...
        <script type="text/javascript">
            function executeFunction()
            {
                  clearOutput();
                   ...
                   var inputElement =  dojo.byId("requestJson");
                   
                   if(inputElement == null)
                   {
                	  //try to find text element (function may not have a complex input)
                	  inputElement = dojo.byId("requestFunctionText");
                	  
                	}
                   
                   if(inputElement == null)
                	{
                	   alert("Input field by names requestJson or requestFunctionText could not be found");
                	   return false;
                	}
                   
                   var jsonFormText = inputElement.value;
                   ...
                   if(theSelectedFunctionText == null)
                         ...
                         var executeFunctionUrl = "<c:out value="${pageContext.request.contextPath}/controller/commas/"/>";
                         
                         //Check if not ROOT blank service name
                         var commasElement = dojo.byId("commas");
                         
                         
                         
                         executeFunctionUrl = executeFunctionUrl + theSelectedFunctionText;
               			...
               			dojo.rawXhrPost({
                                    ...
                                    postData : jsonFormText,
                                     load : function(response, ioArgs) {
                                                ...
                                                var totalTimeMilliSecs = endDate.getTime() - startDate.getTime();
                                                var totalTimeSeconds = totalTimeMilliSecs / 1000.00;
                                                
                                                println("<strong>Execution Time::</strong> "+totalTimeMilliSecs+" (milliseconds) or "+totalTimeSeconds+"  (seconds) <br/><br/><br/>"+response);
                                                return response;
                                          },
                                          //---------------------------------------------------
            ...
            function displayCommandSelect()
            {
                  ...
                  //alert("displayFunctionSelectCrateName:"+displayFunctionSelectCrateName);
                 ...
                 dojo.xhrGet({
                               ...
                               load : function(response, ioArgs) {
                                          ...
                                          for(i in response.commandFacties)
                                          {
                                                ...
                                                selectHTML = selectHTML +"<option value='"+response.commandFacties[i].commandName+"'>"+response.commandFacties[i].simpleName+"</option>";
                                          }
            ...
            function getSelectedFunctionText()
            {
                  ...
                  if(selectedFunction.selectedIndex == 0)
                {
                  ...
                  return selectedFunction.options[selectedFunction.selectedIndex].value;
            }//-----------------
            ...
            function displayForm()
            {
                  ...
                  var getUrl = "<c:out value="${pageContext.request.contextPath}/controller/commas"/>/solutions.global.web.commas.WebCommasCatalog.getJsonCommasSchema?";
                  
                 // var rootCommas = dojo.byId("commas").value;
                  
                  /*if(rootCommas != undefined && rootCommas.length > 0 )
                  {
                	  getUrl = getUrl + rootCommas +".";
                  }*/
                  
                  getUrl =  getUrl +selectedCommasText;
                    ...
                    dojo.xhrGet({
                                     ...
                                     load : function(response, ioArgs) {
                                                ...
                                                {
                                                      responseHTML= responseHTML+"<textarea id='requestFunctionText' rows='4' cols='100'/><br/>";
                                                }
...
them out -->
                ...
                <div class="grouping">
                              ...
                              <div id="functionSelectCanvas">
                              	<label>Command:</label><select id='command' onchange='displayForm();' name='command'><option></option>
                              		<c:forEach var="facts" items="${ui.defaultCommasCommandFacts}">
                                   		<option value="<c:out value="${facts.name}"/>"><c:out value="${facts.simpleName}"></c:out></option>
                                   </c:forEach>
                                   </select>
                              </div>        
