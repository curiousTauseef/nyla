...
public class TimeSlot implements Serializable, Comparable<Object>, TimeInterval
{
   ...
   /**
    * 
    * @param intervalSeconds the time slot durations
   ...
   /**
    *
    * @see nyla.solutions.global.data.TimeInterval#getStartDate()
    */
   ...
   /**
    *
    * @see nyla.solutions.global.data.TimeInterval#setStart(java.util.Date)
    */
   ...
   /**
    *
    * @see nyla.solutions.global.data.TimeInterval#getEnd()
    */
   ...
   /**
    *
    * @see nyla.solutions.global.data.TimeInterval#setEnd(java.util.Date)
    */
