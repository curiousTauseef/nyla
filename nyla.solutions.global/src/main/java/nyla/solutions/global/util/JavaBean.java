...
import nyla.solutions.global.patterns.conversion.PropertyConverter;
			...
			for(Map.Entry<?, ?> entry : aValues.entrySet())
			 {
			     key = entry.getKey();
			   	 ...
			   	 keyValue = entry.getValue();
			    	 ...
			    	 PropertyDescriptor desc =  PropertyUtils.getPropertyDescriptor(aBean, String.valueOf(key));
			    	 if(desc == null)
		    			 continue; //skip
		        ...
		        PropertyUtils.setProperty(aBean,String.valueOf(key),keyValue);
		  }
	}
	catch (Exception e)
	{
   ...
   public static void setProperty(Object aBean, String aPropName, Object aValue)
   {
      ...
      catch(NoSuchMethodException e)
      {
         try
         {
            ...
            PropertyUtils.setProperty(aBean, key.toString(), aValue);
         }
         catch (Exception e1)
         {
