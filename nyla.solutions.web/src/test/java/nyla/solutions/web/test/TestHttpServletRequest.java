...
public class TestHttpServletRequest implements HttpServletRequest
{
	 ...
	 */
	public synchronized HttpSession getSession(boolean aNeedsNew)
	{
		if (aNeedsNew || session == null)
	...
	{
		return  Arrays.toString(params.get(aName));
	}// --------------------------------------------
	...
	{
		String [] values = {aValue};
		params.put(aName,values );
