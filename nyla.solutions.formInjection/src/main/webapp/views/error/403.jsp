...
<table id="403_table" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:0px; margin-left:0px;">
  <tr>
  ...
  <tr>
    <td height="350px" width="100%" valign="top" style="padding-top:30px; padding-left:30px; font-family:Verdana; font-size:10px">
      <h2>403 Error</h2>
      <br />
      The page you requested requires special access permission 
    </td>
  </tr>
  <tr>
