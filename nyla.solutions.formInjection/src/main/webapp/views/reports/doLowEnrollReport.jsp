...
<html:form action="/LowEnrollReportAction?method=doLowEnrollReportAction&amp;landingPage=reports&amp;selectTab=subjectActivity">
      ...
      <td>
         <table border="0" cellpadding="1" cellspacing="1">
            <tbody>            
              ...
              <tr>
                 <td class="reportsLink">Closure Date Range</td>
                 <td class="reportsLink">
                 	Begin
