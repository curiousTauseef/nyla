...
import org.solutions.form.formatter.NumberLabelDecorator;
...
public abstract class PDFDecorator extends FormDecorator
{
    ...
    * @see org.solutions.form.formatter.FormDecorator#getNumberLabel(org.solutions.form.data.FormQuestion)
    */
